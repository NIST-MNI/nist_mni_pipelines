...
def nl_xfm_to_elastix(xfm, elastix_par):
    ...
    with minc_tools.mincTools() as minc:
        ...
        if not os.path.exists(grid):
          ...
          raise minc_tools.mincError("Unfortunately currently only a very primitive way of dealing with Minc XFM files is implemented\n{}".format(traceback.format_exc()))
...
def register_elastix( 
    ...
    with minc_tools.mincTools() as minc:
        ...
        with minc_tools.cache_files(work_dir=work_dir,context='elastix') as tmp:
