...
def linear_registration(
    ...
    try:
        ...
        with mincTools() as m:
            ...
            if bbox:
                ...
                if symmetric:
                    ...
                    if sample.mask_f is not None:
                        mask=m.tmp('mask_f.mnc')
        ...
        print("Exception in linear_registration:{} {}".format(sample.name,str(e)))
        traceback.print_exc(file=sys.stderr)
        raise
    except :
        print("Exception in linear_registration:{} {}".format(sample.name,sys.exc_info()[0]))
        traceback.print_exc(file=sys.stderr)
        raise
...
def elastix_registration(
    ...
    try:
        ...
        print("Exception in elastix_registration:{} {}".format(sample.name,str(e)))
        traceback.print_exc(file=sys.stderr)
        raise
    except :
        print("Exception in elastix_registration:{} {}".format(sample.name,sys.exc_info()[0]))
        traceback.print_exc(file=sys.stderr)
        raise
...
def non_linear_registration(
    ...
    try:
        ...
        print("Exception in non_linear_registration:{} {}".format(sample.name,repr(e)))
        traceback.print_exc(file=sys.stderr)
        raise
    except :
        print("Exception in non_linear_registration:{} {}".format(sample.name,sys.exc_info()[0]))
        traceback.print_exc(file=sys.stderr)
        raise
