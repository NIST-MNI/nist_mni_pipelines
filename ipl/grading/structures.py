...
class MriDataset(object):
    ...
    def __repr__(self):
        return "MriDataset(\n prefix=\"{}\",\n name=\"{}\",\n scan=\"{}\",\n scan_f=\"{}\",\n mask=\"{}\",\n mask_f=\"{}\",\n seg=\"{}\",\n seg_f=\"{}\",\n protect={},\n add={},\n add_f={},\n group={}\n grading={})".\
               format(self.prefix,self.name,self.scan,self.scan_f,self.mask,self.mask_f,self.seg,self.seg_f,repr(self.protect),repr(self.add),repr(self.add_f),self.group,self.grading)
...
class GMRIEncoder(json.JSONEncoder):
