...
def save_summary(iter_summary,
    ...
    for line in file_in:
        line_modified = line.replace(replace_names['main_image'], iter_summary['t1w_tal_noscale'])
        line_modified = line_modified.replace(replace_names['mask'], iter_summary['t1w_tal_noscale_mask'])
        line_modified = line_modified.replace(replace_names['cortex'], iter_summary['t1w_tal_noscale_cortex'])
        line_modified = line_modified.replace(replace_names['skin'], iter_summary['t1w_tal_noscale_skin'])
                    ...
                    if IBIS_parameters['skin'] or IBIS_parameters['cortex'] :
                        ...
                        if IBIS_parameters['cortex'] :
                            with mincTools(verbose=2) as minc:
                                ...
                                iter_summary['t1w_tal_noscale_cortex'] = t1w_tal_noscale_cortex
                        ...
                        if IBIS_parameters['skin'] :
                            with mincTools(verbose=2) as minc:
                                ...
                                iter_summary['t1w_tal_noscale_skin'] = t1w_tal_noscale_skin
