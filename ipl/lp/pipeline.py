    ...
    try:
        with temp_files() as tmp:
            ...
            if manual is not None:
                manual_clp_dir = manual+os.sep+'clp'
                manual_tal_dir = manual+os.sep+'tal'
            ...
            if manual is not None:
                ...
                if os.path.exits(manual_t1w_tal_xfm.xfm) and init_t1w_lin_xfm is None: # HACK ish...
