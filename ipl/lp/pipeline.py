...
def save_summary(iter_summary,
    ...
    for line in file_in:
        line_modified = line.replace(replace_names['main_image'], iter_summary['t1w_tal_noscale'].fname)
        line_modified = line_modified.replace(replace_names['mask'], iter_summary['t1w_tal_noscale_mask'].fname)
